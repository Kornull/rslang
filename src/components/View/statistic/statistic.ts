...
const rowStatistic = ['Количество новых слов', 'Процент правильных ответов', 'Лучшая серия'];
const rowStatisticWords = ['Количество новых слов', 'Количество изученных слов', 'Процент правильных ответов'];
...
export async function createStatisticPage() {
  ...
  const wordsStat: HTMLElement = createStatisticItem(titleStatistic[2], rowStatisticWords, [audioResult[0] + sprintResult[0], 0, percentTrue]);
